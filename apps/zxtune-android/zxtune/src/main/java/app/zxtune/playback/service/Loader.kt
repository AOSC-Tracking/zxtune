...
internal class Loader {
    ...
    private suspend fun loadModule(id: Identifier) = loadModule(open(id.dataLocation), id.subPath)
    ...
    private suspend fun open(uri: Uri) = withContext(Dispatchers.IO + CoroutineName("loadData")) {
        LOG.d { "loadData($uri)" }
